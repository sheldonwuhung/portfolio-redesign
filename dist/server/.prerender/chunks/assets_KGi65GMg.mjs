...
import { A as MissingImageDimension, N as NoImageMetadata, T as LocalImageUsedWrongly, V as RemoteImageNotAllowed, X as UnsupportedImageFormat, Y as UnsupportedImageConversion, b as IncompatibleDescriptorOptions, d as ExpectedNotESMImage, f as FailedToFetchRemoteImageDimensions, l as ExpectedImage, n as AstroError, t as shorthash, u as ExpectedImageOptions, w as InvalidImageService } from "./shorthash_KFJyzn8G.mjs";
...
var baseService = {
	...
	getURL(options, imageConfig) {
		...
		let url = `${joinPaths("/portfolio-redesign", imageConfig.endpoint.route)}?${searchParams}`;
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service-workerd_D6Ycnt8c.mjs").catch((e) => {
...
//#endregion
export { removeBase as C, trimSlashes as D, slash as E, prependForwardSlash as S, removeTrailingForwardSlash as T, fileExtension as _, baseService as a, isRemotePath as b, isESMImportedImage as c, isRemoteAllowed as d, matchPattern as f, collapseDuplicateTrailingSlashes as g, collapseDuplicateSlashes as h, getImage as i, isRemoteImage as l, collapseDuplicateLeadingSlashes as m, propsToFilename as n, inferRemoteSize as o, appendForwardSlash as p, getConfiguredImageService as r, fetchWithRedirects as s, hashTransform as t, resolveSrc as u, hasFileExtension as v, removeLeadingForwardSlash as w, joinPaths as x, isInternalPath as y };
